  ...
  return (
    <div className='min-h-screen bg-[var(--background)] text-[var(--foreground)]'>
      <div className='grid min-h-screen lg:grid-cols-[200px_minmax(0,1fr)]'>
        <aside className='sticky top-0 max-h-screen overflow-y-auto border-b border-[var(--border)] bg-[var(--surface)] px-4 py-6 lg:border-r lg:border-b-0 lg:px-4'>
          <div className='mb-8'>
        ...
        <div className='flex min-h-screen flex-col'>
          <header className='sticky top-0 z-10 border-b border-[var(--border)] bg-[var(--surface)] px-4 py-4 lg:px-8'>
