...
export function ClientCabinetShell({ children, pageTitle }: ClientCabinetShellProps) {
  return (
    <div className='min-h-screen bg-[var(--background)] text-[var(--foreground)]'>
      <MobileNav brandLabel='Next Level Ops' navItems={clientNavigationItems} />

      <div className='grid lg:min-h-screen lg:grid-cols-[200px_minmax(0,1fr)]'>
        <aside className='sticky top-0 hidden max-h-screen overflow-y-auto border-r border-[var(--border)] bg-[var(--surface)] px-4 py-6 lg:block'>
          <div className='mb-8'>
