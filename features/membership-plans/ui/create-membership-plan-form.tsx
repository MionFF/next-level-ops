...
export default function CreateMembershipPlanForm() {
  ...
  const [status, setStatus] = useState<MembershipPlanStatus>('active')
  ...
  return (
    ...
    >
      <div className='mb-6'>
        ...
        <h1 className='mt-2 text-2xl font-semibold text-[var(--foreground)]'>Add plan</h1>
        <p className='mt-2 text-sm text-[var(--muted)]'>
          Create a membership plan available to studio members.
        </p>
      </div>
