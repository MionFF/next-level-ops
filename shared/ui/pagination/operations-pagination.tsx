...
export type OperationsPaginationProps = {
  ariaLabel: string
  currentPage: number
  totalPages: number
  totalCount: number
    ...
    >
      ...
      <div className='flex min-w-0 items-center justify-center gap-1 sm:gap-2'>
        {isFirstPage ? (
          ...
          <>
            <PaginationLink href={getPageHref(1)} label='First' direction='first' />
            <PaginationLink
        ...
        {isLastPage ? (
          ...
          <>
            <PaginationLink href={getPageHref(currentPage + 1)} label='Next' direction='next' />
            <PaginationLink href={getPageHref(totalPages)} label='Last' direction='last' />
          </>
        )}
      </div>
    </nav>
